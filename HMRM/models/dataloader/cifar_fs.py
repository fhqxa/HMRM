    ...
    def __init__(self, setname, args=None, return_path=False):
       ...
       #args.data_dir=' E:/00_Projects_Station/dataset/'
        ...
        if setname == 'train':
            ...
            label_list = os.listdir(THE_PATH)#返回THE_PATH文件夹下所有的文件或者文件夹名列表
        elif setname == 'test':
        ...
        folders = [osp.join(THE_PATH, label) for label in label_list if os.path.isdir(osp.join(THE_PATH, label))]#isdir判断是否为目录
